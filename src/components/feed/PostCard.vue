...
.post-card__username { font-size: 13px; font-weight: 600; }
.post-card__time { font-size: 11px; color: var(--color-text-muted); }
.post-card__image-wrapper { width: 100%; background: var(--color-surface-alt); }
.post-card__image { width: 100%; display: block; object-fit: cover; max-height: 600px; }
.post-card__body { padding: 12px 14px; }
.post-card__actions { display: flex; align-items: center; gap: 12px; margin-bottom: 8px; }
...
.post-card__likes { font-size: 13px; font-weight: 600; margin-bottom: 4px; }
.post-card__caption { font-size: 13px; color: var(--color-text); line-height: 1.5; margin-bottom: 4px; word-break: break-word; }
.post-card__caption-author { font-weight: 600; color: var(--color-text); text-decoration: none; margin-right: 4px; }
.post-card__caption-author:hover { text-decoration: underline; }
.post-card__comments-link { display: block; font-size: 13px; color: var(--color-text-muted); text-decoration: none; margin-bottom: 4px; }
